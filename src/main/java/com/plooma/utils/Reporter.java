...
import com.plooma.testbase.DriverInstance;


public abstract class Reporter extends com.plooma.testbase.DriverInstance {
	...
	public synchronized void startReport() {
		...
		htmlReporter.config().setDocumentTitle("DOFY");
		htmlReporter.config().setEncoding("utf-8");
		htmlReporter.config().setReportName("Plooma Automating Test Report");
